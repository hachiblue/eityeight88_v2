	...
	<div id="aside" class="hidden-md hidden-lg">
		...
		<div id="areaMenu" class="pd20">
			<ul class="nav navbar-nav hidden-md hidden-lg menu-mobile">
				<li class="active"><a href="#" class="no-padd">HOME</a></li>
				<li><a href="#about" class="no-padd">ABOUT US</a></li>
				<li><a href="#product" class="no-padd">PRODUCT</a></li>
				<li><a href="#contact" class="no-padd">CONTACT US</a></li>
			</ul>
		</div>
